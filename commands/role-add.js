...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addRoleOption((option) => option.setName("role").setDescription("Role to give yourself.").setRequired(true)),
  async execute(interaction) {
    ...
    if (
      ...
      // reply
      const replyEmbed = new MessageEmbed().setColor(role.hexColor).setTitle("Assigned a role!").setDescription(`We gave you the role ${role.name}`);
